  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "surprise-kittens.core/on-figwheel-reload"}

                :compiler {:main surprise-kittens.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/surprise_kittens.js"
